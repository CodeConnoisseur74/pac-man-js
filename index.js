  ...
  init() {
    ...
    ghosts = [
      new Ghost({
        ...
        assetsSrc: './assets/sprites/orangeGhost.png',
        state: 'active',
        speed: ghostSpeed,
        outOfCage: true,
      }),
      new Ghost({
        ...
        assetsSrc: './assets/sprites/greenGhost.png',
        speed: ghostSpeed,
      }),
      new Ghost({
        ...
        assetsSrc: './assets/sprites/redGhost.png',
        speed: ghostSpeed,
      }),
      new Ghost({
        ...
        assetsSrc: './assets/sprites/yellowGhost.png',
        speed: ghostSpeed,
      }),
    ];
...
if (keys.ArrowUp.pressed && lastKey === 'ArrowUp') player.move('up');
else if (keys.ArrowLeft.pressed && lastKey === 'ArrowLeft') player.move('left');
else if (keys.ArrowDown.pressed && lastKey === 'ArrowDown') player.move('down');
else if (keys.ArrowRight.pressed && lastKey === 'ArrowRight') player.move('right');
